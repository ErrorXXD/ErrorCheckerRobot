...
if (preg_match('/^(\/id|\.id|!info)/', $text)) {
    ...
    $m = "↳ 𝙐𝙎𝙀𝙍 𝙄𝙉𝙏𝙄𝙈𝘼𝙏𝙄𝙊𝙉 ↲%0A━━━━━━━━━━━━━%0A<b>× UESERNAME - @$username%0A× USAGE NAME  ↯ $firstname%0A× TG ID  ↯ <code>$userId</code>%0A× CHAT ID ↯ <code>$chatId</code>%0A× RANK ↯ $rank%0A× PLAN EXPIREY ↯ $expiryDate</b>%0A━━━━━━━━━━━━━%0A<b>|×| DEV - @ERR0R9</b>";
